...
public record GameFinderAdminStatusResponse(
    ...
    public record PlayerMissingClassification(
            ...
            long unknownCount,
            long recoverablePlayerCount,
            long multiplayerKnownButCapacityUnknown,
            long insufficientSourceCount,
        ...
        static PlayerMissingClassification from(PlayerMissingClassificationProjection value) {
            return new PlayerMissingClassification(
                    ...
                    value.getRecoverablePlayerCount(),
                    value.getMultiplayerKnownButCapacityUnknown(),
                    value.getInsufficientSourceCount(),
