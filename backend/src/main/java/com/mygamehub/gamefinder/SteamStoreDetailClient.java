...
public class SteamStoreDetailClient {
    private final RestClient client; private final ExternalApiRetry retry;
    public SteamStoreDetailClient(RestClient.Builder builder,ExternalApiRetry retry){client=builder.baseUrl("https://store.steampowered.com").build();this.retry=retry;}
